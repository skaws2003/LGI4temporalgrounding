...
class Single_LGI(AbstractNetwork):
    ...
    def reset_status(self, init_reset=False):
        ...
        """
        super(Single_LGI, self).reset_status(init_reset=init_reset)
    ...
    def bring_dataset_info(self, dset):
        super(Single_LGI, self).bring_dataset_info(dset)
...
class LGI(torch.nn.Module):
    ...
    def __init__(self,config, logger=None, verbose=True, device_ids=None, output_device=None):
        ...
        self.module = Single_LGI(config,logger=logger,verbose=verbose)
